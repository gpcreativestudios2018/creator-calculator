...
export const methodology: Record<string, PlatformMethodology> = {
  ...
  instagram: {
    howItWorks:
      'Instagram does not have a reliable, publicly available creator monetization program. The Reels Bonus program was invite-only and has been discontinued for most creators. This calculator returns $0 for Instagram because there is no consistent way to earn directly from the platform.',
    formulas: [
      {
        name: 'Platform Revenue',
        formula: '$0',
        explanation:
          'Instagram does not pay creators directly. Any previous bonus programs were invite-only, temporary, and have largely ended.',
      },
    ],
    assumptions: [
      'No public monetization program exists for most creators',
      'Reels Bonus program was discontinued/paused for most users',
      'Brand deals exist but are negotiated externally (not platform payments)',
      'This calculator only estimates platform-direct payments',
    ],
    disclaimer:
      'Instagram does not pay creators directly through any public program. Creators can earn through brand sponsorships and affiliate marketing, but these are external deals not calculated here. We show $0 because we cannot reliably estimate platform-direct income.',
    sources: [
  ...
  linkedin: {
    howItWorks:
      'LinkedIn does not have a creator monetization program. There is no ad revenue sharing, no creator fund, and no direct payment system for content creators. This calculator returns $0 for LinkedIn.',
    formulas: [
      {
        name: 'Platform Revenue',
        formula: '$0',
        explanation:
          'LinkedIn does not pay creators. The platform has no revenue sharing or creator payment program.',
      },
    ],
    assumptions: [
      'LinkedIn has no creator payment program',
      'No ad revenue sharing exists',
      'Brand deals are external and not platform payments',
      'Business leads are indirect value, not platform income',
    ],
    disclaimer:
      'LinkedIn does not pay creators directly. While the platform can generate business opportunities and brand deals, these are external arrangements not calculated here. We show $0 because LinkedIn has no creator monetization program.',
    sources: [
      { name: 'LinkedIn Help', url: 'https://www.linkedin.com/help/linkedin' },
    ],
    lastUpdated: 'January 2025',
    version: 'v1.1',
  },
  ...
  pinterest: {
    howItWorks:
      'Pinterest does not have a creator monetization program. The Creator Rewards program ended in November 2022. This calculator returns $0 for Pinterest because there is no way to earn directly from the platform.',
    formulas: [
      {
        name: 'Platform Revenue',
        formula: '$0',
        explanation:
          'Pinterest does not pay creators. The Creator Rewards program ended in November 2022.',
      },
    ],
    assumptions: [
      'Creator Rewards program ended November 2022',
      'No current creator payment program exists',
      'Affiliate revenue is external, not platform payments',
      'Traffic value is indirect and not calculated here',
    ],
    disclaimer:
      'Pinterest does not pay creators directly. The Creator Rewards program was discontinued in November 2022. Creators can use Pinterest to drive traffic to monetized sites, but the platform itself pays nothing. We show $0 accordingly.',
    sources: [
      { name: 'Pinterest Help Center', url: 'https://help.pinterest.com/' },
    ],
    lastUpdated: 'January 2025',
    version: 'v1.1',
  },
  ...
  fanvue: {
    howItWorks:
      'Fanvue is a creator subscription platform similar to OnlyFans and Fansly. The platform takes a 20% fee on all earnings, with creators keeping 80%. Revenue comes from monthly subscriptions and tips.',
    formulas: [
      {
        name: 'Subscription Revenue',
        formula: 'subscribers × subscriptionPrice × 0.80',
        explanation:
          'Monthly subscribers times subscription price, minus Fanvue\'s 20% platform fee.',
      },
      {
        name: 'Tips',
        formula: 'tipRevenue × 0.80',
        explanation:
          'Tips from fans, minus the 20% platform fee.',
      },
      {
        name: 'Total Revenue',
        formula: '(subscriptions + tips) × 0.80',
        explanation:
          'Combined subscription and tip revenue after Fanvue\'s 20% fee.',
      },
    ],
    assumptions: [
      'Fanvue takes 20% of all revenue',
      'Same fee structure as OnlyFans and Fansly',
      'Platform is newer with a growing creator base',
      'Success depends on bringing your own audience',
    ],
    disclaimer:
      'Fanvue takes a 20% platform fee, the same as OnlyFans and Fansly. Success depends on bringing your own audience and consistent content creation.',
    sources: [
  ...
  threads: {
    howItWorks:
      'Threads does not have a creator monetization program. A temporary bonus program existed but has ended. This calculator returns $0 for Threads because there is no way to earn directly from the platform.',
    formulas: [
      {
        name: 'Platform Revenue',
        formula: '$0',
        explanation:
          'Threads does not pay creators. The temporary bonus program has ended.',
      },
    ],
    assumptions: [
      'No monetization program currently exists',
      'Temporary bonus program has ended',
      'Brand deals are external, not platform payments',
      'No announced timeline for creator payments',
    ],
    disclaimer:
      'Threads does not pay creators directly. A temporary bonus program existed but has since ended. We show $0 because there is no current way to earn from the platform directly.',
    sources: [
